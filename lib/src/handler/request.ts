...
export class Request<Body = any> implements RequestModel<Body> {
    ...
    constructor({ body = {} as any, method = '' as any, name = '', attributes = {}, params = {}, headers = {}, dateTime = new Date(Date.now()), access = '', context = '', module = '', origin = '' }: Partial<RequestModel<Body>>) {
        this.body = body
